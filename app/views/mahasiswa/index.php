            ...
            <ul class="list-group">
                <?php foreach($data['mhs'] as $mhs) : ?>
                    <li class="list-group-item ">
                        <?php echo $mhs['nama']; ?>
                        <a href="<?php echo BASEURL; ?> /mahasiswa/hapus/<?php echo $mhs['id']; ?>" class="badge badge-danger float-right ml-1" onclick="return confirm('Apakah anda yakin?');"> Hapus </a>
                        <a href="<?php echo BASEURL; ?> /mahasiswa/update/<?php echo $mhs['id']; ?>" class="badge badge-success float-right ml-1 tampilModalUpdate" data-toggle="modal" data-target="#formModal" data-id="<?php echo $mhs['id']; ?>"> Update </a>
